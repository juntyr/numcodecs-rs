...
[PyPi Release]: https://img.shields.io/pypi/v/numcodecs-wasm-qpet-sz.svg
[pypi]: https://pypi.python.org/pypi/numcodecs-wasm-qpet-sz
...
[rtdocs]: https://numcodecs-wasm.readthedocs.io/en/stable/api/numcodecs_wasm_qpet_sz/
...
The `numcodecs-qpet-sz` crate has been developed as part of [ESiWACE3](https://www.esiwace.eu), the third phase of the Centre of Excellence in Simulation of Weather and Climate in Europe.

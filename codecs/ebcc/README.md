...
[PyPi Release]: https://img.shields.io/pypi/v/numcodecs-wasm-ebcc.svg
[pypi]: https://pypi.python.org/pypi/numcodecs-wasm-ebcc
...
[rtdocs]: https://numcodecs-wasm.readthedocs.io/en/stable/api/numcodecs_wasm_ebcc/
...
The `numcodecs-ebcc` crate has been developed as part of [ESiWACE3](https://www.esiwace.eu), the third phase of the Centre of Excellence in Simulation of Weather and Climate in Europe.

...
pub fn default_engine(py: Python) -> Result<wasmtime_runtime_layer::Engine, PyErr> {
...
pub fn default_engine(py: Python) -> Result<pyodide_webassembly_runtime_layer::Engine, PyErr> {
